...
class PoliceAuthProvider with ChangeNotifier {
  ...
  Future<void> registerPolice({
    ...
    try {
      ...
      if (sdpo != null && sdpo.isNotEmpty) policeData['sdpo'] = sdpo;
      if (circle != null && circle.isNotEmpty) policeData['circle'] = circle;
  ...
  Future<void> forgotPassword(String email) async {
    try {
      // Check if email exists in 'police' collection
      ...
      if (querySnapshot.docs.isEmpty) {
        throw Exception('This email is not registered as a police account.');
      }
      ...
      if (e.toString().contains('is not registered')) rethrow;
