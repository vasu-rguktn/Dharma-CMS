...
class AuthProvider with ChangeNotifier {
  ...
  Future<void> updateUserProfile({
    ...
    try {
      ...
      if (phoneNumber != null && phoneNumber.isNotEmpty && !Validators.isValidIndianPhone(phoneNumber)) {
        throw Exception('Invalid phone number');
      }

      if (dob != null && dob.isNotEmpty && !Validators.isValidDOB(dob)) {
        throw Exception('Invalid DOB');
      }

      if (pincode != null && pincode.isNotEmpty && !Validators.isValidIndianPincode(pincode)) {
        throw Exception('Invalid pincode');
      }
