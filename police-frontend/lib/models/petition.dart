...
class Petition {
  ...
  final String? assignedToSDPO; // ✅ NEW: SDPO assigned to
  final String? assignedToCircle; // ✅ NEW: Circle assigned to
  ...
  Petition({
    ...
    this.assignedToSDPO, // ✅ NEW
    this.assignedToCircle, // ✅ NEW
  ...
  factory Petition.fromFirestore(DocumentSnapshot doc) {
    ...
    return Petition(
      ...
      assignedToSDPO: data['assignedToSDPO'], // ✅ NEW
      assignedToCircle: data['assignedToCircle'], // ✅ NEW
