...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get nameOnlyLetters =>
      'పేరులో అక్షరాలు మరియు స్పేస్‌లు మాత్రమే ఉండాలి';
  ...
  @override
  String get pleaseSelectDOB => 'దయచేసి మీ పుట్టిన తేదీని ఎంచుకోండి';

  @override
  String get enterValidDateFormat =>
      'తేదీని YYYY-MM-DD ఫార్మాట్‌లో నమోదు చేయండి';

  @override
  String get pleaseSelectGender => 'దయచేసి మీ లింగాన్ని ఎంచుకోండి';

  @override
  String get fillFieldsCorrectly => 'దయచేసి అన్ని ఫీల్డ్‌లను సరిగ్గా పూరించండి';

  @override
  String get addressDetails => 'చిరునామా వివరాలు';

  @override
  String get houseNo => 'ఇంటి నెం';

  @override
  String get cityTown => 'నగరం/పట్టణం';
  ...
  @override
  String get policeStation => 'పోలీస్ స్టేషన్';

  @override
  String get enterHouseNumber => 'దయచేసి మీ ఇంటి నెంబర్‌ను నమోదు చేయండి';

  @override
  String get enterCity => 'మీ నగరాన్ని నమోదు చేయండి';

  @override
  String get enterDistrict => 'మీ జిల్లాను నమోదు చేయండి';

  @override
  String get enterState => 'మీ రాష్ట్రాన్ని నమోదు చేయండి';

  @override
  String get enterCountry => 'మీ దేశాన్ని నమోదు చేయండి';

  @override
  String get enterPincode => 'దయచేసి మీ పిన్‌కోడ్‌ని నమోదు చేయండి';

  @override
  String get enterValidPincode =>
      'చెల్లుబాటు అయ్యే 6-అంకెల పిన్‌కోడ్‌ని నమోదు చేయండి';

  @override
  String get enterPoliceStation => 'పోలీస్ స్టేషన్‌ని నమోదు చేయండి';

  @override
  String get personalDataNotProvided => 'లోపం: వ్యక్తిగత సమాచారం అందించబడలేదు';

  @override
  String get loginDetails => 'లాగిన్ వివరాలు';
  ...
  String get enterUsername =>
      'వినియోగదారు పేరును నమోదు చేయండి (కనీసం 4 అక్షరాలు)';

  @override
  String get usernameEmpty => 'వినియోగదారు పేరును నమోదు చేయండి';

  @override
  String get usernameMinLength => 'వినియోగదారు పేరు కనీసం 4 అక్షరాలు ఉండాలి';

  @override
  String get password => 'పాస్‌వర్డ్';

  @override
  String get enterPassword => 'పాస్‌వర్డ్‌ను నమోదు చేయండి (కనీసం 6 అక్షరాలు)';

  @override
  String get passwordEmpty => 'పాస్‌వర్డ్‌ను నమోదు చేయండి';
  ...
  @override
  String get reenterPassword => 'పాస్‌వర్డ్‌ని మళ్లీ నమోదు చేయండి';

  @override
  String get confirmPasswordEmpty => 'మీ పాస్‌వర్డ్‌ని నిర్ధారించండి';

  @override
  String get passwordsDoNotMatch => 'పాస్‌వర్డ్‌లు సరిపోలడం లేదు';

  @override
  String get dataNotProvided => 'లోపం: అవసరమైన సమాచారం అందించబడలేదు';

  @override
  String get invalidEmail => 'లోపం: చెల్లని ఇమెయిల్ అందించబడింది';

  @override
  String get failedToCreateUser => 'లోపం: వినియోగదారుని సృష్టించడం విఫలమైంది';

  @override
  String get registrationSuccessful => 'నమోదు విజయవంతమైంది!';

  @override
  String get emailAlreadyRegistered => 'ఈ ఇమెయిల్ ఇప్పటికే నమోదు చేయబడింది.';

  @override
  String get invalidEmailAddress => 'ఇమెయిల్ చిరునామా చెల్లదు.';

  @override
  String get weakPassword => 'పాస్‌వర్డ్ చాలా బలహీనంగా ఉంది.';

  @override
  String get unexpectedError => 'అనుకోని లోపం సంభవించింది.';

  @override
  String get fixFormErrors => 'దయచేసి ఫారమ్‌లోని లోపాలను సరిచేయండి';

  @override
  String get welcomeMessage => 'ధర్మ CMS కి స్వాగతం';
  ...
  @override
  String get cases => 'కేసులు';

  @override
  String get complaints => 'ఫిర్యాదులు';

  @override
  String get petitions => 'పిటిషన్లు';
  ...
  @override
  String get policeCommandCentre => 'పోలీస్ కమాండ్ సెంటర్';
  ...
  @override
  String get noRecentActivity => 'ఇటీవలి కార్యకలాపం లేదు';

  @override
  String get totalCases => 'మొత్తం కేసులు';

  @override
  String get activeCases => 'క్రియాశీల కేసులు';

  @override
  String get closedCases => 'మూసివేసిన కేసులు';

  @override
  String get totalPetitions => 'మొత్తం అర్జీలు';

  @override
  String get aiChat => 'AI చాట్';

  @override
  String get legalQueries => 'చట్టపరమైన ప్రశ్నలు';
  ...
  @override
  String get chargesheetGen => 'ఆరోపణ పత్రం రూపకల్పన';

  @override
  String get chargesheetVetting => 'ఆరోపణ పత్రం పరిశీలన';

  @override
  String get witnessPrep => 'సాక్షి సిద్ధం';

  @override
  String get mediaAnalysis => 'మీడియా విశ్లేషణ';

  @override
  String get caseJournal => 'కేసు జర్నల్';

  @override
  String get caseManagement => 'కేసు నిర్వహణ';

  @override
  String get aiTools => 'AI సాధనాలు';
  ...
  @override
  String get newCase => 'కొత్త కేసు';

  @override
  String get allCases => 'అన్ని కేసులు';

  @override
  String get noCasesFound => 'కేసులు కనుగొనబడలేదు';
  ...
  @override
  String get aiLegalAssistant => 'AI న్యాయ సహాయకుడు';
  ...
  String get askLegalQuestions =>
      'చట్టపరమైన ప్రశ్నలు అడగండి మరియు AI-ఆధారిత సమాధానాలు పొందండి';

  @override
  String get submitQuery => 'ప్రశ్న సమర్పించు';

  @override
  String get enterLegalQuestion =>
      'మీ చట్టపరమైన ప్రశ్నను ఇక్కడ నమోదు చేయండి...';

  @override
  String get previousQueries => 'మునుపటి ప్రశ్నలు';

  @override
  String get noQueriesYet => 'ఇంకా ప్రశ్నలు లేవు';

  @override
  String get submitFirstQuery => 'పైన మీ మొదటి చట్టపరమైన ప్రశ్నను సమర్పించండి';

  @override
  String get legalSectionSuggester => 'చట్టపరమైన సెక్షన్ సూచనకర్త';

  @override
  String get firDetails => 'FIR వివరాలు';

  @override
  String get incidentDetails => 'సంఘటన వివరాలు';

  @override
  String get generateSuggestions => 'సూచనలను రూపొందించండి';
  ...
  @override
  String get medicalOfficer => 'వైద్య అధికారి';

  @override
  String get forensicExpert => 'ఫోరెన్సిక్ నిపుణుడు';

  @override
  String get generateDraft => 'డ్రాఫ్ట్ రూపొందించండి';

  @override
  String get chargesheetGenerator => 'ఛార్జ్‌షీట్ జనరేటర్';

  @override
  String get evidenceSummary => 'సాక్ష్యాల సారాంశం';

  @override
  String get generateChargesheet => 'ఛార్జ్‌షీట్ రూపొందించండి';

  @override
  String get chargesheetContent => 'ఛార్జ్‌షీట్ కంటెంట్';

  @override
  String get vetChargesheet => 'ఛార్జ్‌షీట్ తనిఖీ చేయండి';

  @override
  String get witnessPreparation => 'సాక్షి తయారీ';

  @override
  String get witnessName => 'సాక్షి పేరు';

  @override
  String get witnessStatement => 'సాక్షి ప్రకటన';

  @override
  String get prepareQuestions => 'ప్రశ్నలు తయారు చేయండి';

  @override
  String get uploadMedia => 'మీడియా అప్‌లోడ్ చేయండి';

  @override
  String get analyzeMedia => 'మీడియాను విశ్లేషించండి';

  @override
  String get caseDetails => 'కేసు వివరాలు';
  ...
  String get addressQuestion =>
      'మీరు ఎక్కడ నివసిస్తున్నారు (ప్రదేశం / ప్రాంతం)?';
  ...
  String get complaintTypeQuestion =>
      'మీరు ఏ రకమైన ఫిర్యాదు ఫైల్ చేయాలనుకుంటున్నారు? (దొంగతనం, వేధింపులు, కనిపించకపోవడం మొదలైనవి)';
  ...
  String pleaseAnswerAllQuestions(String missing) =>
      'దయచేసి సమర్పించే ముందు అన్ని ప్రశ్నలకు సమాధానం ఇవ్వండి. తప్పిపోయినవి: $missing';
  ...
  String get somethingWentWrong =>
      'క్షమించండి, ఏమో తప్పు జరిగింది. దయచేసి తదుపరి ప్రయత్నించండి.';
  ...
  String get viewAndManageComplaints =>
      'మీ సేవ్ చేసిన ఫిర్యాదు చిత్తుప్రతులను వీక్షించండి మరియు నిర్వహించండి';

  @override
  String get savedComplaintsAppearHere =>
      'మీ సేవ్ చేసిన ఫిర్యాదు చిత్తుప్రతులు ఇక్కడ కనిపిస్తాయి';
  ...
  String get deleteComplaintConfirmation =>
      'మీరు ఖచ్చితంగా ఈ ఫిర్యాదును తొలగించాలనుకుంటున్నారా?';
  ...
  String get petitionCreatedSuccessfully =>
      'పిటిషన్ విజయవంతంగా సృష్టించబడింది!';
  ...
  String get createFirstPetition =>
      '"కొత్తది సృష్టించండి" ట్యాబ్ ఉపయోగించి మీ మొదటి పిటిషన్‌ను సృష్టించండి';
  ...
  String get enterFirAndIncidentDetails =>
      'దయచేసి FIR మరియు సంఘటన వివరాలు రెండూ నమోదు చేయండి.';
  ...
  String get provideFirDetailsDesc =>
      'BNS, BNSS, BSA మరియు ఇతర ప్రత్యేక చట్టాల కింద వర్తించే చట్టపరమైన విభాగాల కోసం AI-ఆధారిత సూచనలను పొందడానికి FIR మరియు సంఘటన వివరాలను అందించండి.';

  @override
  String get enterFirDetailsHint =>
      'ప్రథమ సమాచార నివేదిక (FIR) నుండి సమగ్ర వివరాలను నమోదు చేయండి...';

  @override
  String get describeIncidentHint =>
      'సంఘటనను వివరంగా వివరించండి, సంఘటనల క్రమం, తీసుకున్న చర్యలు మొదలైనవి...';
  ...
  String get analyzingInformation =>
      'సమాచారాన్ని విశ్లేషించడం మరియు సూచనలను రూపొందించడం...';
  ...
  String get reviewSuggestionsDesc =>
      'సూచించిన చట్టపరమైన విభాగాలు మరియు కారణాలను సమీక్షించండి. ఇది సమాచార ప్రయోజనాల కోసం మాత్రమే.';
  ...
  String get aiDisclaimer =>
      'AI- రూపొందించిన కంటెంట్. అధికారిక సలహా కోసం ఎల్లప్పుడూ న్యాయ నిపుణుడిని సంప్రదించండి.';

  @override
  String get provideCaseDataAndRecipient =>
      'దయచేసి కేసు డేటాను అందించండి మరియు గ్రహీత రకాన్ని ఎంచుకోండి.';
  ...
  String get documentDraftingDesc =>
      'వైద్య అధికారులు లేదా ఫోరెన్సిక్ నిపుణుల వంటి నిర్దిష్ట గ్రహీతల కోసం కేసు డేటా ఆధారంగా పత్ర చిత్తుప్రతులను రూపొందించండి.';

  @override
  String get pasteCaseDataHint =>
      'అన్ని సంబంధిత కేసు డేటాను అతికించండి: ఫిర్యాదు ట్రాన్‌స్క్రిప్ట్‌లు, సాక్షి వాంగ్మూలాలు, FIR వివరాలు, దర్యాప్తు గమనికలు మొదలైనవి...';
  ...
  String get additionalInstructionsOptional =>
      'అదనపు సూచనలు (కావాలంటే ఇవ్వొచ్చు)';

  @override
  String get additionalInstructionsHint =>
      'ఉదా., \'గాయాలపై దృష్టి పెట్టండి\', \'DNA విశ్లేషణ కోసం నిర్దిష్ట పరీక్షలను అభ్యర్థించండి\', \'స్వరాన్ని అధికారికంగా మరియు అత్యవసరంగా ఉంచండి\'...';
  ...
  String get draftingWait =>
      'పత్రం చిత్తుప్రతి చేస్తోంది, దయచేసి వేచి ఉండండి...';
  ...
  String get reviewDraftDesc =>
      'రూపొందించిన చిత్తుప్రతిని సమీక్షించండి. మీరు అవసరమైన విధంగా కాపీ చేసి సవరించవచ్చు.';
  ...
  String get aiDraftDisclaimer =>
      'AI- రూపొందించిన కంటెంట్. అధికారిక ఉపయోగం కోసం ధృవీకరించండి మరియు స్వీకరించండి.';
  ...
  String get pleaseUploadDocument =>
      'దయచేసి కనీసం ఒక పత్రాన్ని అప్‌లోడ్ చేయండి.';

  @override
  String get draftChargeSheetGenerated =>
      'చిత్తుప్రతి ఛార్జ్ షీట్ రూపొందించబడింది.';
  ...
  String get chargesheetGeneratorDesc =>
      'సంబంధిత పత్రాలను (FIR, సాక్షి వాంగ్మూలాలు, సాక్ష్యం నివేదికలు .doc, .docx, .pdf, .txtలో) అప్‌లోడ్ చేయండి మరియు అదనపు సూచనలను అందించండి. AI అందించిన టెంప్లేట్ ఆధారంగా చిత్తుప్రతి ఛార్జ్ షీట్‌ను రూపొందిస్తుంది.';
  ...
  String get chargesheetInstructionsHint =>
      'ఉదా., \'నిందితుడు Aని దొరికిన ఆయుధంతో అనుసంధానించడంపై దృష్టి పెట్టండి.\', \'సాక్షి B వాంగ్మూలం ఆధారంగా ముందస్తు ప్రణాళిక అంశాన్ని నొక్కి చెప్పండి.\'...';
  ...
  String get generateDraftChargeSheet =>
      'చిత్తుప్రతి ఛార్జ్ షీట్‌ను రూపొందించండి';

  @override
  String get generatingChargeSheetWait =>
      'ఛార్జ్ షీట్‌ను రూపొందిస్తోంది, దీనికి కొంత సమయం పట్టవచ్చు...';
  ...
  String get reviewChargeSheetDesc =>
      'రూపొందించిన చిత్తుప్రతిని సమీక్షించండి. ఇది ప్రారంభ స్థానం మరియు అసలు పత్రాలకు వ్యతిరేకంగా న్యాయ సమీక్ష మరియు ధృవీకరణ అవసరం.';
  ...
  String get aiChargeSheetDisclaimer =>
      'AI- రూపొందించిన కంటెంట్. న్యాయ నిపుణుడిచే సమీక్షించబడాలి మరియు ధృవీకరించబడాలి.';
  ...
  String get pleaseUploadOrPasteChargesheet =>
      'దయచేసి ఛార్జ్ షీట్ కంటెంట్‌ను అప్‌లోడ్ చేయండి లేదా అతికించండి.';

  @override
  String get chargesheetVettedSuccess =>
      'ఛార్జ్ షీట్ పరిశీలించబడింది మరియు సూచనలు అందించబడ్డాయి.';
  ...
  String get chargesheetVettingDesc =>
      'ఇప్పటికే ఉన్న ఛార్జ్ షీట్‌ను అప్‌లోడ్ చేయండి లేదా అతికించండి. AI దానిని సమీక్షిస్తుంది మరియు కేసును బలోపేతం చేయడానికి మెరుగుదలలను సూచిస్తుంది.';
  ...
  String get fileLoadedEditBelow =>
      'ఫైల్ లోడ్ చేయబడింది. మీరు క్రింద సవరించవచ్చు.';
  ...
  String get pasteChargesheetHint =>
      'ఛార్జ్ షీట్ యొక్క పూర్తి కంటెంట్‌ను ఇక్కడ అతికించండి...';
  ...
  String get vettingChargesheetWait =>
      'ఛార్జ్ షీట్‌ను పరిశీలిస్తోంది, దయచేసి వేచి ఉండండి...';
  ...
  String get reviewSuggestionsToImprove =>
      'ఛార్జ్ షీట్‌ను మెరుగుపరచడానికి సూచనలను సమీక్షించండి.';
  ...
  String get aiVettingDisclaimer =>
      'AI- రూపొందించిన సూచనలు. తుది నిర్ణయాల కోసం న్యాయ నైపుణ్యం అవసరం.';

  @override
  String get pleaseFillAllWitnessFields =>
      'దయచేసి అన్ని ఫీల్డ్‌లను పూరించండి: కేసు వివరాలు, సాక్షి ప్రకటన మరియు సాక్షి పేరు.';
  ...
  String get witnessPreparationDesc =>
      'సాక్షి కోసం మాక్ ట్రయల్ అనుభవాన్ని అనుకరించండి. AI సహాయకుడు సంభావ్య క్రాస్-ఎగ్జామినేషన్ ప్రశ్నలను అడుగుతుంది.';
  ...
  String get caseDetailsHint =>
      'సమగ్ర కేసు వివరాలను అందించండి: ఆరోపణలు, సాక్ష్యం, తెలిసిన వాస్తవాలు మొదలైనవి.';

  @override
  String get witnessStatementHint =>
      'మాక్ ట్రయల్ కోసం ఉపయోగించబడే సాక్షి ప్రకటనను నమోదు చేయండి.';
  ...
  String get preparingMockTrialWait =>
      'మాక్ ట్రయల్ సెషన్‌ను తయారు చేస్తోంది...';
  ...
  String get aiSimulationDisclaimer =>
      'ఇది AI అనుకరణ. నిజమైన ట్రయల్ పరిస్థితులు మారవచ్చు.';
  ...
  String get pleaseSelectImageToAnalyze =>
      'దయచేసి విశ్లేషించడానికి చిత్రాన్ని ఎంచుకోండి.';

  @override
  String get analysisComplete =>
      'విశ్లేషణ పూర్తయింది. క్రింద AI-రూపొందించిన కనుగొన్నవాటిని సమీక్షించండి.';
  ...
  String get mediaAnalysisDesc =>
      'క్రైమ్ సీన్ విశ్లేషణ కోసం చిత్రాన్ని (గరిష్టంగా 10MB) అప్‌లోడ్ చేయండి. AI అంశాలను గుర్తిస్తుంది, దృశ్యాన్ని వివరిస్తుంది మరియు సారాంశాన్ని అందిస్తుంది.';
  ...
  String get contextInstructionsHint =>
      'ఉదా., \'సంభావ్య ఆయుధాలపై దృష్టి పెట్టండి.\', \'బలవంతంగా ప్రవేశించిన సంకేతం ఏదైనా ఉందా?\', \'టేబుల్‌పై ఉన్న నోట్‌లో ఏమి వ్రాయబడింది?\'';
  ...
  String get analyzingImageWait =>
      'AI చిత్రాన్ని విశ్లేషిస్తోంది, దయచేసి వేచి ఉండండి...';

  @override
  String get analyzingComplexityNote =>
      '(చిత్ర సంక్లిష్టతను బట్టి ఇది కొంత సమయం పట్టవచ్చు)';
  ...
  String get noElementsIdentified =>
      'నిర్దిష్ట అంశాలు ప్రముఖంగా గుర్తించబడలేదు లేదా విశ్లేషణ అసంపూర్ణంగా ఉంది.';
  ...
  String get sceneNarrativeHint =>
      'AI-రూపొందించిన దృశ్య కథనం ఇక్కడ కనిపిస్తుంది. మీరు దీన్ని సవరించవచ్చు.';

  @override
  String get caseFileSummaryEditable =>
      'కేసు ఫైల్ సారాంశం & పరికల్పనలు (సవరించదగినది)';

  @override
  String get caseFileSummaryHint =>
      'AI-రూపొందించిన సారాంశం మరియు పరికల్పనలు ఇక్కడ కనిపిస్తాయి. మీరు దీన్ని సవరించవచ్చు.';

  @override
  String get aiAnalysisDisclaimer =>
      'AI-రూపొందించిన విశ్లేషణ. భౌతిక పరిశోధనతో ధృవీకరించండి.';
  ...
  String get journalEntryAddedSuccess =>
      'జర్నల్ ఎంట్రీ విజయవంతంగా జోడించబడింది';
  ...
  String get caseJournalDesc =>
      'పరిశోధన డైరీలు మరియు కేసు కార్యాచరణ లాగ్‌లను వీక్షించండి';
  ...
  String get noCasesAvailable =>
      'కేసులు అందుబాటులో లేవు. దయచేసి ముందుగా కేసును నమోదు చేయండి.';

  @override
  String get chooseCaseToViewJournal =>
      'జర్నల్ వీక్షించడానికి కేసును ఎంచుకోండి';
  ...
  String get noJournalEntriesDesc =>
      'పరిశోధన పురోగమిస్తున్నప్పుడు జర్నల్ ఎంట్రీలు ఇక్కడ కనిపిస్తాయి.';
  ...
  String get appDescription =>
      'AI సాంకేతికతతో శక్తివంతం చేయబడిన చట్టపరమైన సహాయ వేదిక.';
  ...
  String get enterValidNumber =>
      'గుర్తుపట్టే 10 అంకెల మొబైల్ నంబర్ నమోదు చేయండి';
  ...
  @override
  String get backToEmailLogin => 'ఇమెయిల్ తో లాగిన్ అవ్వండి';
  ...
  String get recentActivityDescription =>
      'మీ ఖాతాకు సంబంధించిన ఇటీవల జరిగిన చర్యలు లేదా నవీకరణలను చూపిస్తుంది';
  ...
  String get tryingToLoginAs =>
      'కానీ మీరు ఈ పాత్రగా లాగిన్ అవ్వడానికి ప్రయత్నిస్తున్నారు';
...
// Police Login & Registration
  ...
  String get policeRegisteredSuccessfully =>
      'పోలీస్ విజయవంతంగా నమోదు చేయబడింది';
  ...
  String get pleaseSelectAllDropdownFields =>
      'దయచేసి అన్ని డ్రాప్‌డౌన్ ఫీల్డ్‌లను ఎంచుకోండి';
  ...
  String get errorContactingInvestigationAI =>
      'దర్యాప్తు AI ని సంప్రదించడంలో లోపం';
  ...
  String get tapToStopRecording =>
      'రికార్డింగ్ ఆపడానికి మైక్రోఫోన్ చిహ్నంపై టాప్ చేయండి';
  ...
  String get filterCasesUsingFilters =>
      'డ్రాప్‌డౌన్ ఫిల్టర్‌లను ఉపయోగించి కేసులను ఫిల్టర్ చేయండి.';

  @override
  String get casesScreenSubtitle =>
      'మీకు సంబంధించిన FIR ల / కేసుల వివరాలను నిర్వహించండి మరియు చూడండి.';
  ...
  String get complainantInformantDetails =>
      '5. ఫిర్యాదుదారు / సమాచారదాత వివరాలు';
  ...
  String get firReadAndAdmittedCorrect =>
      'FIR చదువబడింది మరియు సరిగా కీకర్లు చేసుకున్నారు';
  ...
  String get signatureThumbImpression =>
      'ఫిర్యాదుదారు/సమాచారదాత సంతకం/బొటనవేలు ముద్ర (అన్వయమైతే \'డిజిటల్‌గా సంతకం చేయబడింది\' లేదా మార్గాన్ని నమోదు చేయండి)';
  ...
  String get noCrimeScenesLinked =>
      'ఈ కేసుకు ఇంకా నేర దృశ్యాలు లింక్ చేయబడలేదు.';
  ...
  String get attachedDocumentsWillAppearHere =>
      'కేసు జర్నల్, పిటిషన్‌లు మరియు నేర దృశ్య సంగ్రహణల నుండి జత చేసిన పత్రాలు ఇక్కడ కనిపిస్తాయి.';

  @override
  String get noDocumentsAttachedJournal =>
      'విచారణ డయరీలో ఇంకా పత్రాలు జత చేయబడలేదు.';

  @override
  String get noPetitionDocumentsLinked =>
      'ఈ కేసుకు ఇంకా పిటిషన్ పత్రాలు లింక్ చేయబడలేదు.';
  ...
  String get noFinalReportAttached =>
      'ఈ కేసుకు చివరి విచారణ నివేదిక జత చేయబడలేదు.';

  @override
  String get onceSomeoneGeneratesReport =>
      'విచారణ అధికారి కేసు జర్నల్ స్క్రీన్ నుండి AI సహాయక విచారణ నివేదికను రూపొందించి నిర్ధారించిన తర్వాత, చివరి PDF ఇక్కడ లింక్ చేయబడుతుంది.';

  @override
  String get courtReadyReportGenerated =>
      'కోర్టుకు సిద్ధ విచారణ నివేదిక PDF రూపొందించబడింది మరియు ఈ కేసుకు జత చేయబడింది.';

  @override
  String get downloadViewFinalReportPDF =>
      'చివరి నివేదిక PDFను డౌన్‌లోడ్ / చూడండి';

  @override
  String get loadingEvidenceFromAllSources =>
      'అన్ని మూలాల నుండి సాక్ష్యం లోడ్ చేయుచున్నది...';
  ...
  String get uploadingCapturedEvidence =>
      'సంగ్రహించిన సాక్ష్యం అప్‌లోడ్ చేయుచున్నది...';
  ...
  String get geoTaggedVideoCaptured =>
      'జియో-ట్యాగ్ చేసిన వీడియో సంగ్రహించబడింది';
  ...
  String get pleaseCapturUploadEvidenceFirst =>
      'మొదట సాక్ష్యం సంగ్రహించండి లేదా అప్‌లోడ్ చేయండి';
  ...
  String get saveToDeviceDownloads =>
      'పరికర డౌన్‌లోడ్‌ల ఫోల్డర్‌కు సేవ్ చేయండి';
  ...
  String get deleteReportConfirmation =>
      'మీరు ఈ విశ్లేషణ నివేదిక తొలగించాలని చేస్తున్నారా? ఇది రద్దు చేయలేము.';
  ...
  String get accessViaFileManager =>
      'ఫైల్ మేనేజర్ → ధర్మ → సాక్ష్యం ద్వారా యాక్సెస్ చేయండి';
  ...
  String get anonymousPetitionConfirm =>
      'మీరు గోపనీయ పిటిషన్ మోడ్‌ను ఎంచుకున్నారు. మీ పేరు మరియు చిరునామా రికార్డ్ చేయబడవు.';
  ...
  String get aiChatInProgressMessage =>
      'మీరు AI చాట్‌బాట్ వినియోగాన్ని ఆపాలనుకుంటున్నారా?';
  ...
  @override
  String get passwordResetLinkSentTo => 'పాస్‌వర్డ్ రీసెట్ లింక్ పంపబడింది,';

  @override
  String get pleaseCheckYourInbox => 'దయచేసి మీ ఇన్‌బాక్స్‌ను తనిఖీ చేయండి';
  @override
  String get rateOfficerAndFeedback => 'అధికారిని రేట్ చేయండి & అభిప్రాయం';
  ...
  @override
  String get feedbackSubmittedSuccessfully => 'అభిప్రాయం విజయవంతంగా పంపబడింది!';
  ...
  @override
  String get whoIsComplaintFor => 'ఈ ఫిర్యాదు ఎవరికోసం?';

  @override
  String get complaintForSelf => 'స్వయంగా మీకోసం ఫిర్యాదు';
